...
func TestListVocab(t *testing.T) {
	...
	srv := NewServer(logr.Discard(), settingsRepo, vocabRepo, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, "")
...
func TestGetVocabDetails(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			srv := NewServer(logr.Discard(), mock.NewMockSettingsRepository(ctrl), vr, nil, nil, nil, nil, nil, dc, nil, nil, nil, nil, nil, "")
